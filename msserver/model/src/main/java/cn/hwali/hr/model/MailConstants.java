...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "hwali.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "hwali.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "hawli.mail.routing.key";
}
